...
# UP 5 DOWN 3 LEFT 3 RIGHT 2 Then, the output of the program should be: 2 The numbers after the direction are steps. 
...
# Example: 
#    Input: 4 UP 5 DOWN 3 LEFT 3 RIGHT 2 
#    Output: 2 Explanation: After the movements, the robot is at the position (-1, 2). 
#                           Distance from the (0, 0) to the point (-1, 2) is calculated as The round value of which is 2.0, and int value is 2. 
